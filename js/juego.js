...
var instrucciones = ["Mover las piezas presionando las teclas de flechas."
,"Encontrar el orden correcto de las piezas."];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  ...
  var posicionNueva = grilla[filaPos2][columnaPos2];
  grilla[filaPos1][columnaPos1] = posicionNueva;
...
/* Intercambia la ficha vacia por la que muevo*/
function moverEnDireccion(direccion) {
  ...
  /* Se chequea si la nueva posición es válida*/
...
//Almacena y pushea el ultimo movimiento//
function almacenarMovimientos (unMovimiento){
  movimientos.push(unMovimiento);
  actualizarUltimoMovimiento(unMovimiento);
}
